             ...
             <div id="category" style="margin-top:20px;">
            	<div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6" >
                                <h1 class="new-video-title"><i class="fa fa-users"></i> Form {{$id==-1 ? 'Tambah' : 'Edit'}} Admin</h1>
                            </div>
                        ...
                        <form id="add-admin" action="{{$id==-1 ? URL::to('mapping-admin') : URL::to('mapping-admin/'.$id) }}" method="POST" enctype="multipart/form-data">
                            @if ($id!=-1)
								{{ method_field('PATCH') }}
                            @endif
                            ...
                            <div class="row" style="margin-top:10px;" id="">
                                <div class="col-md-12" >
                                        ...
                                        <br>
                                        <button type="submit" class="btn btn-default btn-block">Simpan Mapping Admin</button>
