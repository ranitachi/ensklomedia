...
@section('title')
    <title>Pengguna - Ensiklomedia</title>
@endsection
             ...
             <div id="category" style="margin-top:20px;">
            	<div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6" >
                                <h1 class="new-video-title"><i class="fa fa-users"></i> Data Pengguna</h1>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <a href="{{url('user')}}/-1" class="btn btn-danger">
                            ...
                            <div class="col-md-4">
                                <div class="pull-right">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="user-search" placeholder="Cari Nama dan Email Pengguna">
    ...
    <script>
        ...
        function getPosts(page) {
            $.ajax({
                    ...
                    alert('Halaman User Tidak Dapat Di Load');
            });
        }
    </script>
@endsection