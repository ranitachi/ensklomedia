             ...
             <div id="category" style="margin-top:20px;">
            	<div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6" >
                                <h1 class="new-video-title"><i class="fa fa-users"></i> Form {{$id==-1 ? 'Tambah' : 'Edit'}} Super User</h1>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="pull-right">
                                    <a href="{{url('mapping-super-user')}}" class="btn btn-danger">
                                        <i class="fa fa-angle-double-left"></i> Kembali
                                    </a>
                                </div>
                            </div>
                        </div>
                        <form id="add-admin" action="{{$id==-1 ? URL::to('mapping-super-user') : URL::to('mapping-super-user/'.$id) }}" method="POST" enctype="multipart/form-data">
                            @if ($id!=-1)
								{{ method_field('PATCH') }}
                            @endif
